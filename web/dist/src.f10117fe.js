...
function () {
  function Eventing() {
    ...
    this.on = function (eventName, callbackFn) {
...
function () {
  ...
  Collection.prototype.fetch = function () {
    ...
    axios_1.default.get(this.rootUrl).then(function (response) {
      ...
      _this.models = data.map(function (value) {
...
function (_super) {
  ...
  User.buildUser = function (user) {
    return new User(new Attributes_1.Attributes(user), new Sync_1.Sync(rootUrl), new Eventing_1.Eventing());
  };
...
exports.User = User;
},{"./Attributes":"src/models/Attributes.ts","./Collection":"src/models/Collection.ts","./Eventing":"src/models/Eventing.ts","./Model":"src/models/Model.ts","./Sync":"src/models/Sync.ts"}],"src/views/CollectionView.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  View.prototype.reigonsMap = function () {
    return {};
  };
  ...
  View.prototype.mapRegions = function (fragment) {
    var reigonsMap = this.reigonsMap();

    for (var key in reigonsMap) {
      var selector = reigonsMap[key];
...
collection.on('change', function () {
  new UserList_1.UserList(document.getElementById('root'), collection).render();
});
collection.fetch();
